...
class Profile
 ...
 #The change_my_age= syntax below might be confusing to see, it just allows
...
#I have to use p below because what_is_age only returns the value of @number, 
#it does not print anything to the console. The p modifier prints to the console 
...
#Let's see the final product now. We changed all of the values using setters, so 
