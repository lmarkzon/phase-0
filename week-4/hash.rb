...
# RSpec Tests. They are included in this file because the local 
#variables you are creating are not accessible across files. If we 
#try to run these files as a separate file per normal operation, 
